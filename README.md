...
- **[CivicPlusPlus](https://github.com/SkyzFallin/CivicPlusPlus)** — OSINT tool for finding city websites on the Civic Plus platform and extracting staff directory info.
